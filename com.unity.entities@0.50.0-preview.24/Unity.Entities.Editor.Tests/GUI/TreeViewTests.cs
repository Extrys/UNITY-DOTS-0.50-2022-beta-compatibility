...
namespace Unity.Entities.Editor.Tests
{
    ...
    class TreeViewTests
    {
        ...
        int m_FinalId;
            Unity.Editor.Bridge.TreeView m_TreeView;
        ListView m_ListView;
        ...
        public void TestsSetup()
        {
            ...
            m_TreeView = new Unity.Editor.Bridge.TreeView(m_RawItemList, 20, makeItem, ve => { }, bindItem);
        ...
        {
            var emptyTreeView = new Unity.Editor.Bridge.TreeView();
