...
namespace Unity.Entities.Editor
{
    class SystemTreeView : VisualElement, IDisposable
    {
        ...
        internal readonly Unity.Editor.Bridge.TreeView m_SystemTreeView; // internal for test.
        ...
        {
            m_SystemTreeView = new Unity.Editor.Bridge.TreeView(m_TreeViewRootItems, Constants.ListView.ItemHeight, MakeTreeViewItem, ReleaseTreeViewItem, BindTreeViewItem)
            {
