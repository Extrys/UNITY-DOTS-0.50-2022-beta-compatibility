...
{
    [UsedImplicitly]
    class Float2Inspector : BaseFieldInspector<UnityEngine.UIElements.Vector2Field, Vector2, float2>
    {
    ...
    [UsedImplicitly]
    class Float3Inspector : BaseFieldInspector<UnityEngine.UIElements.Vector3Field, Vector3, float3>
    {
    ...
    [UsedImplicitly]
    class Float4Inspector : BaseFieldInspector<UnityEngine.UIElements.Vector4Field, Vector4, float4>
    {
    ...
    [UsedImplicitly]
    class QuaternionInspector : BaseFieldInspector<UnityEngine.UIElements.Vector4Field, Vector4, quaternion>
    {
